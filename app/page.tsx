...
export default function Home() {
  ...
  return (
    <>
      ...
      <section>
        <div className='flex'>
          <div className='w-[480px] p-4 border-r-2 border-black h-screen overflow-y-auto md:pt-20'>
          ...
          <div className='max-xl:hidden flex xl:w-[65%] justify-center items-center'>
