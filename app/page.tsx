...
export default function Home() {
  ...
  const handleLoginClick = () => {
    setShowHome(false);
    console.log("showHomel" , showHome)
  };
  const handleLogoClick = () => {
    setShowHome(true);
    console.log("showHomeh" , showHome)
    ...
    <>
      ...
      <section>
        <div className='flex '>
          ...
          {showHome ? ( <div className='p-4'><div className='text-18px font-semibold py-4'>
              <h1>Our Tournaments</h1>
            </div><div className='grid grid-cols-2 2xl:grid-cols-2 gap-4'>
                <div>
              ...
              </div><div className='slider-container mt-5 md:pb-24 pb-10  '>
                <Slider {...settings}>
                  <div>
                    <Image src={logo} alt='/' />
                  </div>
              ...
              </div><div className='fixed bottom-0 left-0 sm:w-[480px] w-full bg-gradient-to-r from-purple-500 to-pink-500'>
                ...
                <div className='bg-slate-600 flex justify-between w-full p-4'>
                  ...
                  <div className="flex flex-col justify-center text-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 958 512" className='pl-3'><path fill='#fff' d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V192c0-35.3-28.7-64-64-64H80c-8.8 0-16-7.2-16-16s7.2-16 16-16H448c17.7 0 32-14.3 32-32s-14.3-32-32-32H64zM416 272a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" /></svg>
                  ...
                  <div className="flex flex-col justify-center text-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className='pl-3'><path fill='#fff' d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM504 312V248H440c-13.3 0-24-10.7-24-24s10.7-24 24-24h64V136c0-13.3 10.7-24 24-24s24 10.7 24 24v64h64c13.3 0 24 10.7 24 24s-10.7 24-24 24H552v64c0 13.3-10.7 24-24 24s-24-10.7-24-24z" /></svg>
                    <button className="mt-1 text-white">Refer</button>
                  </div>
                </div>
              </div></div>
              ) : (
